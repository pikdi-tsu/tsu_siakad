                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div id="form-container" style="display: none;" class="mb-4 p-3 border rounded bg-light">
                                <h5 class="text-primary mb-3" id="form-title"><i class="fas fa-edit"></i> Input Jenis Tinggal</h5>
                                <form id="form-tinggal">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kode_jenis" id="kode_jenis" class="form-control" placeholder="Contoh: 1" required>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <label>Nama Jenis Tinggal <span class="text-danger">*</span></label>
                                                <input type="text" name="nama_jenis" id="nama_jenis" class="form-control" placeholder="Contoh: Kos / Asrama" required>
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="table-tinggal" class="table table-bordered table-striped" style="width: 100%;">
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            // 3. SUBMIT FORM
            $('#form-tinggal').submit(function(e) {
                e.preventDefault();
            ...
            $('body').on('click', '.btn_edit', function() {
                ...
                $.get("{{ route('jenis_tinggal.index') }}" + '/edit/' + id, function(res) {
                    if (res.status == 'success') {
                        ...
                        $('#form-title').html('<i class="fas fa-edit"></i> Edit Jenis Tinggal');
                        $('#form-container').slideDown();
            ...
            function resetForm() {
                $('#form-tinggal')[0].reset();
                $('#id').val('');
                $('#form-title').html('<i class="fas fa-plus"></i> Input Jenis Tinggal');
            }
        });
    </script>
@endsection
