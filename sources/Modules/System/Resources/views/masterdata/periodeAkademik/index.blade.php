                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                ...
                                <button class="btn btn-danger" id="btn-hapus-bulk"><i class="fas fa-trash"></i>
                                    Hapus</button>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kode_periode" id="kode_periode"
                                                    class="form-control" placeholder="20251" required>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_periode" id="nama_periode"
                                                    class="form-control" placeholder="2025 Ganjil" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tgl_awal_kuliah" id="tgl_awal_kuliah"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tgl_akhir_kuliah" id="tgl_akhir_kuliah"
                                                    class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tgl_awal_uts" id="tgl_awal_uts"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tgl_awal_uas" id="tgl_awal_uas"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#table-periode').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('setting.periode_akademik.index') }}",
                columns: [{
                        data: 'checkbox',
                        orderable: false,
                        searchable: false,
                    ...
                    {
                        data: 'tgl_awal_kuliah',
                        name: 'tgl_awal_kuliah'
                    },
                    {
                        data: 'tgl_akhir_kuliah',
                        name: 'tgl_akhir_kuliah'
                    },
                    {
                        data: 'tgl_awal_uts',
                        name: 'tgl_awal_uts',
            ...
            window.setActive = function(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "{{ url('setting/setting/periode/set-active') }}/" + id,
            ...
            $('body').on('click', '.btn_edit', function() {
                var id = $(this).data('id');
                $.get("{{ route('setting.periode_akademik.edit', ':id') }}".replace(':id', id),
                    function(res) {
                        if (res.status == 'success') {
                            $('#id').val(res.data.id);
            ...
            $('body').on('click', '.btn_hapus', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('setting.periode_akademik.delete', ':id') }}"
                                .replace(':id', id),
