                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div id="form-container" style="display: none;" class="mb-4 p-3 border rounded bg-light">
                                <h5 class="text-primary mb-3" id="form-title"><i class="fas fa-edit"></i> Input Jas Almamater</h5>
                                <form id="form-jas">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kode_ukuran" id="kode_ukuran" class="form-control" placeholder="Contoh: XL" required>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <label>Nama Ukuran / Deskripsi <span class="text-danger">*</span></label>
                                                <input type="text" name="nama_ukuran" id="nama_ukuran" class="form-control" placeholder="Contoh: Extra Large" required>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#table-jas').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('jas_almamater.index') }}",
                columns: [
            ...
            $('body').on('click', '.btn_edit', function() {
                var id = $(this).data('id');
                $.get("{{ route('jas_almamater.index') }}" + '/edit/' + id, function(res) {
            ...
            $('body').on('click', '.btn_hapus', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('jas_almamater.index') }}" + '/delete/' + id,
                            success: function(res) {
