                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div id="form-container" style="display: none;" class="mb-4 p-3 border rounded bg-light">
                                <h5 class="text-primary mb-3" id="form-title"><i class="fas fa-edit"></i> Input Jenis Modul
                                </h5>
                                <form id="form-modul">
                                    @csrf
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_modul" id="nama_modul" class="form-control"
                                                    placeholder="Contoh: Praktikum" required>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#table-modul').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('perkuliahan.jenis_modul_mata_kuliah.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
                        searchable: false
            ...
            $('#form-modul').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('perkuliahan.jenis_modul_mata_kuliah.store') }}",
                    data: formData,
                    contentType: false,
                    processData: false,
