                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div id="form-container" style="display: none;" class="mb-4 p-3 border rounded bg-light">
                                <h5 class="text-primary mb-3" id="form-title"><i class="fas fa-edit"></i> Input Kebutuhan Khusus</h5>
                                <form id="form-kebutuhan">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kode_kebutuhan" id="kode_kebutuhan" class="form-control" placeholder="Contoh: A / C1" required>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <label>Nama Kebutuhan Khusus <span class="text-danger">*</span></label>
                                                <input type="text" name="nama_kebutuhan" id="nama_kebutuhan" class="form-control" placeholder="Contoh: Tuna Netra" required>
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="table-kebutuhan" class="table table-bordered table-striped" style="width: 100%;">
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            // 3. SUBMIT FORM
            $('#form-kebutuhan').submit(function(e) {
                e.preventDefault();
            ...
            $('body').on('click', '.btn_edit', function() {
                ...
                $.get("{{ route('kebutuhan_khusus.index') }}" + '/edit/' + id, function(res) {
                    if (res.status == 'success') {
                        ...
                        $('#nama_kebutuhan').val(res.data.nama_kebutuhan);

                        $('#form-title').html('<i class="fas fa-edit"></i> Edit Kebutuhan');
                        $('#form-container').slideDown();
            ...
            function resetForm() {
                $('#form-kebutuhan')[0].reset();
                $('#id').val('');
                $('#form-title').html('<i class="fas fa-plus"></i> Input Kebutuhan Khusus');
            }
        });
    </script>
@endsection
