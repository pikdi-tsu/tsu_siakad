                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div id="form-container" style="display: none;" class="mb-4 p-3 border rounded bg-light">
                                <h5 class="text-primary mb-3" id="form-title"><i class="fas fa-edit"></i> Input Status Mahasiswa</h5>
                                <form id="form-status">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kode_status" id="kode_status" class="form-control" placeholder="A" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Nama Status Mahasiswa <span class="text-danger">*</span></label>
                                                <input type="text" name="nama_status" id="nama_status" class="form-control" placeholder="Aktif / Cuti" required>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group clearfix">
                                                        <div class="icheck-primary d-inline">
                                                            <input type="checkbox" id="is_pengajuan_mhs" name="is_pengajuan_mhs">
                                                            <label for="is_pengajuan_mhs" style="font-weight: normal;">Diajukan Mhs?</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group clearfix">
                                                        <div class="icheck-success d-inline">
                                                            ...
                                                            <label for="is_aktif" style="font-weight: normal;">Status Aktif?</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group clearfix">
                                                        <div class="icheck-success d-inline">
                                                            ...
                                                            <label for="is_sks" style="font-weight: normal;">Bisa Kuliah?</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        $(document).ready(function() {
            ...
            var table = $('#table-status').DataTable({
                ...
                columns: [
                    ...
                    { data: 'is_pengajuan_mhs', name: 'is_pengajuan_mhs', className: 'text-center' },
                    { data: 'is_aktif', name: 'is_aktif', className: 'text-center' },
                    { data: 'is_sks', name: 'is_sks', className: 'text-center' },
