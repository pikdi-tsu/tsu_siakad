                                            ...
                                            <div class="col-md-6 pt-2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group clearfix">
                                                            <div class="icheck-primary d-inline">
                                                                <input type="checkbox" id="is_untuk_dosen"
                                                                    name="is_untuk_dosen" checked>
                                                                <label for="is_untuk_dosen"
                                                                    style="font-weight: normal;">Berlaku
                                                                    Dosen?</label>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('body').on('click', '.btn_edit', function() {
                    var id = $(this).data('id');
                    $.get("{{ route('perkuliahan.status_hadir.edit', ':id') }}".replace(':id', id),
                        function(res) {
                            if (res.status == 'success') {
                                $('#id').val(res.data.id);
                ...
                $('body').on('click', '.btn_hapus', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "DELETE",
                                url: "{{ route('perkuliahan.status_hadir.delete', ':id') }}"
                                    .replace(':id', id),
                                success: function(res) {
