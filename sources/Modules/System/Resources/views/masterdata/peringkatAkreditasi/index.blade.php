                ...
                <div class="card-body">
                    ...
                    <div id="form-container" style="display:none" class="mb-4 p-3 border rounded bg-light">
                        <h5 class="text-primary mb-3" id="form-title">
                            <i class="fas fa-plus"></i> Input Peringkat Akreditasi
                        </h5>

                        <form id="form-peringkat-akreditasi">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Peringkat Akreditasi <span class="text-danger">*</span></label>
                                        <input type="text" name="peringkat_akreditasi" id="peringkat_akreditasi"
                                            class="form-control" placeholder="Contoh: Unggul / A / B" required>
                                    </div>
                                </div>
                    ...
                    <div class="table-responsive">
                        <table id="table-peringkat-akreditasi" class="table table-bordered table-striped">
...
@section('script')
    <script>
        $(function() {
            ...
            $('#form-peringkat-akreditasi').submit(function(e) {
                e.preventDefault();
            ...
            function resetForm() {
                $('#form-peringkat-akreditasi')[0].reset();
                $('#id').val('');
                $('#form-title').html('<i class="fas fa-plus"></i> Input Peringkat Akreditasi');
            }
