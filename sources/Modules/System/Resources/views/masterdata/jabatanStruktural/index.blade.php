                        ...
                        <div class="card-body">
                            ...
                            <div id="form-container" class="mb-4 p-3 border rounded bg-light" style="display:none">
                                ...
                                <h5 class="text-primary mb-3" id="form-title">
                                    <i class="fas fa-plus"></i> Input Jabatan Struktural
                                </h5>

                                <form id="form-jabatan-struktural">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nama Jabatan Struktural <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="nama_jabatan_struktural"
                                                    id="nama_jabatan_struktural" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Parent Jabatan Struktural</label>
                                                <input type="text" class="form-control" name="parent_jabatan_struktural"
                                                    id="parent_jabatan_struktural">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table id="table-jabatan-struktural" class="table table-bordered table-striped"
                                    style="width:100%">
                                    <thead style="background:#003366;color:white">
                                        <tr>
                                            <th width="5%">No</th>
                                            <th>Nama Jabatan Struktural</th>
                                            <th>Parent Jabatan Struktural</th>
        ...
        $(document).ready(function() {
            ...
            let table = $('#table-jabatan-struktural').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'nama_jabatan_struktural',
                        name: 'nama_jabatan_struktural'
                    },
                    {
                        data: 'parent_jabatan_struktural',
                        name: 'parent_jabatan_struktural'
                    },
                    {
                        data: 'action',
                        orderable: false,
            ...
            $('body').on('click', '.btn_edit', function() {
                ...
                $.get("{{ route('pegawai.jabatan_struktural.edit', ':id') }}".replace(':id', id), function(
                    ...
                    if (res.status === 'success') {
                        ...
                        $('#parent_jabatan_struktural').val(res.data.parent_jabatan_struktural);
                        $('#form-title').html(
                            '<i class="fas fa-edit"></i> Edit Jabatan Struktural');
                        $('#form-container').slideDown();
                    }
                });
            });
            ...
            function resetForm() {
                ...
                $('#id').val('');
                $('#form-title').html('<i class="fas fa-plus"></i> Input Jabatan Struktural');
            }
