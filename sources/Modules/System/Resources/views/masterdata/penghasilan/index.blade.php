                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div id="form-container" style="display: none;" class="mb-4 p-3 border rounded bg-light">
                                <h5 class="text-primary mb-3" id="form-title"><i class="fas fa-edit"></i> Input Penghasilan
                                </h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kode_penghasilan" id="kode_penghasilan"
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_penghasilan" id="nama_penghasilan"
                                                    class="form-control" placeholder="Contoh: 1 Juta - 2 Juta" required>
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="table-penghasilan" class="table table-bordered table-striped"
                                    style="width: 100%;">
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#table-penghasilan').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('biodata.penghasilan.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
                        searchable: false
                    ...
                    {
                        data: 'kode_penghasilan',
                        name: 'kode_penghasilan'
                    },
                    {
                        data: 'nama_penghasilan',
                        name: 'nama_penghasilan'
                    },
                    {
                        data: 'action',
                        orderable: false,
            ...
            $('#form-penghasilan').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('biodata.penghasilan.store') }}",
                    data: formData,
                    contentType: false,
                    processData: false,
            ...
            $('body').on('click', '.btn_edit', function() {
                var id = $(this).data('id');
                $.get("{{ route('biodata.penghasilan.index') }}" + '/edit/' + id, function(res) {
                    if (res.status == 'success') {
                        $('#id').val(res.data.id);
            ...
            $('body').on('click', '.btn_hapus', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('biodata.penghasilan.index') }}" + '/delete/' +
                                id,
                            success: function(res) {
