        ...
        $(function() {
            ...
            function tabelKabupaten() {
                let otable = $('#example2').DataTable({
                    ...
                    order: [],
                    ajax: {
                        url: '{!! route('wilayah.admin.Kabupaten.Tabel') !!}',
                        type: 'GET',
                    },
                    columns: [{
                            data: 'DT_RowIndex',
            ...
            {{--                    $.ajax({ --}}
            {{--                        type: "POST", --}}
            {{--                        url: "{{route('wilayah.admin.Kabupaten.Store')}}", --}}
            {{--                        data: dataku, --}}
            {{--                        dataType: "JSON", --}}
            ...
            {{--                $.ajax({ --}}
            {{--                    type: "GET", --}}
            {{--                    url: '{!! url('wilayah/admin/MasterData/Kabupaten/Delete') !!}' + '/' + params, --}}
            {{--                    dataType: "JSON", --}}
            {{--                    beforeSend: function(response) { --}}
            {{--                        $('#loading').show() --}}
            {{--                    }, --}}
