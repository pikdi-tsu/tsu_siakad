                        ...
                        <div class="card-body">
                            ...
                            <div id="form-container" class="mb-4 p-3 border rounded bg-light" style="display:none">
                                ...
                                <h5 class="text-primary mb-3" id="form-title">
                                    <i class="fas fa-plus"></i> Input Penyelenggara Sertifikat
                                </h5>

                                <form id="form-penyelenggara-sertifikat">
                                    @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    name="nama_penyelenggara_sertifikat" id="nama_penyelenggara_sertifikat"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table id="table-penyelenggara-sertifikat" class="table table-bordered table-striped"
                                    style="width:100%">
        ...
        $(document).ready(function() {
            ...
            let table = $('#table-penyelenggara-sertifikat').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'nama_penyelenggara_sertifikat',
                        name: 'nama_penyelenggara_sertifikat'
                    },
                    {
                        data: 'action',
                        orderable: false,
            ...
            $('#btn-tambah').click(function() {
                ...
                $('#nama_penyelenggara_sertifikat').focus();
            });
            ...
            function resetForm() {
                $('#form-penyelenggara-sertifikat')[0].reset();
                $('#id').val('');
                $('#form-title').html('<i class="fas fa-plus"></i> Input Penyelenggara Sertifikat');
            }
