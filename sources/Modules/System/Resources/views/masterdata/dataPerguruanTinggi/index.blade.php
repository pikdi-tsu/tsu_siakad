                                ...
                                <form action="{{ route('perguruan_tinggi.perguruan_tinggi.save') }}" id="form-edit-pt"
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="showpt">{{ $pt == null ? '-' : $pt->tanggal_sk_pendirian }}</span>
                                                <input type="date" class="form-control editpt" name="tglskpendirian"
                                                    value="{{ $pt == null ? null : $pt->tanggal_sk_pendirian }}"
                                                    id="tglskpendirian" style="display:none;">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select class="form-control select2 editpt" id="rektor"
                                                    name="rektor"style="display:none;">
                                            ...
                                            <td>
                                                ...
                                                <select class="form-control select2 editpt" id="wr3"
                                                    name="wr3"style="display:none;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select class="form-control select2 editpt" id="wr1"
                                                    name="wr1"style="display:none;">
                                            ...
                                            <td>
                                                ...
                                                <select class="form-control select2 editpt" id="wr4"
                                                    name="wr4"style="display:none;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select class="form-control select2 editpt" id="wr2"
                                                    name="wr2"style="display:none;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="showpt">{{ $pt == null ? '-' : $pt->lembaga_akreditasi }}</span>
                                                <input type="text" class="form-control editpt"
                                                    name="lembaga_akreditasi" id="lembaga_akreditasi"
                                                    style="display:none;">
                                            </td>
                                            <th class="text-primary">Tgl SK Akreditasi</th>
                                            <td>
                                                <span
                                                    class="showpt">{{ $pt == null ? '-' : $pt->tanggal_sk_akreditasi }}</span>
                                                <input type="date" class="form-control editpt" name="tglskakreditasi"
                                                    id="tglskakreditasi" style="display:none;">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="showpt">{{ $pt == null ? '-' : $pt->tanggal_berlaku_akreditasi }}</span>
                                                <input type="date" class="form-control editpt"
                                                    name="tglberlakuakreditasi" id="tglberlakuakreditasi"
                                                    style="display:none;">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="number" class="form-control editpt" min="0"
                                                    max="999" name="nilai_akreditasi" id="nilai_akreditasi"
                                                    title="Isian maksimal 3 karakter, isian harus angka"
                                                    style="display: none;">
                                            </td>
                                            <th class="text-primary">Tgl Berakhir Akreditasi</th>
                                            <td>
                                                <span
                                                    class="showpt">{{ $pt == null ? '-' : $pt->tanggal_berakhir_akreditasi }}</span>
                                                <input type="date" class="form-control editpt"
                                                    name="tglberakhirakreditasi" id="tglberakhirakreditasi"
                                                    style="display:none;">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" class="form-control editpt" name="nosk_akreditasi"
                                                    id="nosk_akreditasi" title="Isian maksimal 100 karakter"
                                                    style="display:none;">
                                            </td>
                                            <th class="text-primary">File Sertifikasi Akreditasi</th>
                                            <td>
                                                <span
                                                    class="showpt text-success">{{ $pt == null ? '-' : $pt->file_sertifikat_akreditasi }}</span>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <input type="text" class="form-control editpt" name="alamat"
                                                    id="alamat" title="Isian maksimal 100 karakter"
                                                    style="display:none;">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <input type="text" class="form-control editpt" name="telp"
                                                    id="telp" title="Isian maksimal 20 karakter"
                                                    style="display:none;">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <input type="text" class="form-control editpt" name="alamatemail"
                                                    id="alamatemail" title="Isian maksimal 100 karakter"
                                                    style="display:none;">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <input type="text" class="form-control editpt" name="alamatweb"
                                                    id="alamatweb" title="Isian maksimal 100 karakter"
                                                    style="display:none;">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <input type="text" class="form-control editpt" name="fax"
                                                    id="fax" title="Isian maksimal 100 karakter"
                                                    style="display:none;">
                                            </td>
                                        </tr>
                                    </table>
