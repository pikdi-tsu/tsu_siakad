                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="masa_studi" id="masa_studi"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="max_cuti" id="max_cuti">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="max_studi" id="max_studi">
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#table-tp-universitas').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('tingkat_pendidikan_universitas.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
                        searchable: false
            ...
            $('#form-tp-universitas').submit(function(e) {
                e.preventDefault();
                $.post("{{ route('tingkat_pendidikan_universitas.store') }}", $(this).serialize(), function(
                    res) {
            ...
            $('body').on('click', '.btn_edit', function() {
                let id = $(this).data('id');
                $.get("{{ route('tingkat_pendidikan_universitas.edit', ':id') }}".replace(':id', id),
                    function(res) {
                        if (res.status === 'success') {
                            $('#id').val(res.data.id);
            ...
            $('body').on('click', '.btn_hapus', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: 'DELETE',
                            url: "{{ route('tingkat_pendidikan_universitas.delete', ':id') }}"
                                .replace(':id', id),
