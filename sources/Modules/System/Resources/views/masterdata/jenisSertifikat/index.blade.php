                        ...
                        <div class="card-body">
                            ...
                            <div id="form-container" class="mb-4 p-3 border rounded bg-light" style="display:none">
                                ...
                                <h5 class="text-primary mb-3" id="form-title">
                                    <i class="fas fa-plus"></i> Input Jenis Sertifikat
                                </h5>

                                <form id="form-jenis-sertifikat">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nama Jenis Sertifikat <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="nama_jenis_sertifikat"
                                                    id="nama_jenis_sertifikat" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Ukom</label>
                                                <input type="text" class="form-control" name="ukom" id="ukom">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table id="table-jenis-sertifikat" class="table table-bordered table-striped"
                                    style="width:100%">
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            function resetForm() {
                $('#form-jenis-sertifikat')[0].reset();
                $('#id').val('');
                $('#form-title').html('<i class="fas fa-plus"></i> Input Jenis Sertifikat');
            }
