                                ...
                                <div class="col-md-6"> <!-- Ubah lebar form di sini -->
                                    <form id="form-fakultas" method="POST" action="#">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="provinsi" name="provinsi" placeholder="Nama Provinsi"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <button type="button" id="submit-batch" class="btn btn-success float-right"
                                                style="margin-left:10px;"> <i class="fas fa-paper-plane"></i>
                                                Submit</button>
        ...
        $(function() {
            ...
            function tabelKelurahan() {
                let otable = $('#example2').DataTable({
                    ...
                    order: [],
                    ajax: {
                        url: '{!! route('wilayah.admin.Kelurahan.Tabel') !!}',
                        type: 'GET',
                    },
                    columns: [{
                            data: 'DT_RowIndex',
            ...
            {{--                    $.ajax({ --}}
            {{--                        type: "POST", --}}
            {{--                        url: "{{route('wilayah.admin.TingkatKejuaraan.Store')}}", --}}
            {{--                        data: dataku, --}}
            {{--                        dataType: "JSON", --}}
            ...
            {{--        $.ajax({ --}}
            {{--            type: "GET", --}}
            {{--            url:  '{!! url('wilayah/admin/MasterData/TingkatKejuaraan/EditTingkat') !!}' + '/' + params, --}}
            {{--            dataType: "JSON", --}}
            {{--            beforeSend: function(response) { --}}
            {{--                $('#loading').show() --}}
            {{--                $('#btn-reset').trigger('click') --}}
            ...
            {{--                $.ajax({ --}}
            {{--                    type: "GET", --}}
            {{--                    url: '{!! url('wilayah/admin/MasterData/TingkatKejuaraan/Delete') !!}' + '/' + params, --}}
            {{--                    dataType: "JSON", --}}
            {{--                    beforeSend: function(response) { --}}
            {{--                        $('#loading').show() --}}
            {{--                    }, --}}
