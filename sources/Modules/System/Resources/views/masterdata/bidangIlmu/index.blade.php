                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div id="form-container" style="display: none;" class="mb-4 p-3 border rounded bg-light">
                                <h5 class="text-primary mb-3" id="form-title"><i class="fas fa-edit"></i> Input Bidang Ilmu
                                </h5>
                                <form id="form-bidang">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kode_bidang_ilmu" id="kode_bidang_ilmu"
                                                    class="form-control" placeholder="Contoh: 111" required>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <label>Nama Bidang Ilmu <span class="text-danger">*</span></label>
                                                <input type="text" name="nama_bidang_ilmu" id="nama_bidang_ilmu"
                                                    class="form-control" placeholder="Contoh: Fisika / Ilmu Komputer"
                                                    required>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#table-bidang').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('perkuliahan.bidang_ilmu.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
                        searchable: false
                    ...
                    {
                        data: 'kode_bidang_ilmu',
                        name: 'kode_bidang_ilmu'
                    },
                    {
            ...
            $('#form-bidang').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('perkuliahan.bidang_ilmu.store') }}",
                    data: formData,
                    contentType: false,
                    processData: false,
            ...
            $('body').on('click', '.btn_edit', function() {
                var id = $(this).data('id');
                $.get("{{ route('perkuliahan.bidang_ilmu.edit', ':id') }}".replace(':id', id), function(
                    res) {
                    if (res.status == 'success') {
                        $('#id').val(res.data.id);
            ...
            $('body').on('click', '.btn_hapus', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('perkuliahan.bidang_ilmu.delete', ':id') }}"
                                .replace(':id', id),
                            success: function(res) {
